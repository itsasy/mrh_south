<form class="" action="" method="post">
    ...
    <div class="form-inline">
        <div class="form-group col-12">
            ...
            <input type="number" name="study_parameter" id="study_parameter" class="form-control col-2" min="0">
        </div>

        <div class="form-group col-12">
            <label class="col-10 justify-content-start" for="number_of_models">Número de modelos
                ortogonales</label>
            <input type="number" name="number_of_models" id="number_of_models" class="form-control col-2" min="0">
        </div>
