    ...
    <div class="form-group col-12 mb-3">
     ...
     <div class="form-group col-12 mb-3">
      ...
      <div class="form-group col-sm-6 mb-3">
        <label class="col-7 justify-content-start" for="number_of_models">Número de modelos ortogonales:</label>
        <input type="number" name="number_of_models" id="number_of_models" class="form-control col-5" min="0"  value="{{$test->nro_modelos_ortogonales ?? ''}}" required>
    </div>

    <div class="form-group col-sm-6 mb-3">
        <label class="col-7 justify-content-start" for="number_of_repeats">Número de
            repeticiones:</label>
        <input type="number" name="number_of_repeats" id="number_of_repeats" class="form-control col-5" min="0" value="{{$test->nro_repeticiones ?? ''}}"
            required>
    </div>
